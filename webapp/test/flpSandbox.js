		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori title cicd",
									"targetURL": "#fioricicddemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioricicddemo-display": {
								"semanticObject": "fioricicddemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioricicddemo",
									"url": sap.ui.require.toUrl("fioricicddemo")
								}
							}
						}
					}
